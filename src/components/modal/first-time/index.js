...
class FirstTime extends Modal {
  constructor() {
    ...
    p1.textContent = "To make the most of our services, we kindly ask you to complete two simple steps:";

    p1.classList.add("bold-p");
    const p2 = document.createElement("p");
    p2.textContent = "1. To apply for jobs, please provide proof of your work eligibility."
    const p3 = document.createElement("p");
    p3.textContent = "2. Set your profile preferences to that we can match you with the best job opportunities."
